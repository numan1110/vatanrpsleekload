...
$int_conf = 1;
 ...
 <?php } ?>
 <div style="<?php if($int_count == 0){ ?>width: 65%;<?php } if($layout_bottom == 1 && $int_count == 0){ ?> left: 0; <?php } ?>"id="server-desc"><div style="margin: -5px 0 0 0px; width: 100%; padding: 5px; font-size: 28px; font-weight: 300; text-align: left;">Description</div><?php echo $description; ?>
</div>
 <div id="server-info">
